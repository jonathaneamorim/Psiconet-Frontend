...
export default async function PsychologistConnectionsPage(props: {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col gap-2 mb-8">
          ...
          <p className="text-slate-600">
            Visualize e gerencie seus pacientes conectados na plataforma.
          </p>
        </div>
        ...
        {data && (
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm px-6 py-4 mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Pacientes conectados a você</p>
            </div>
          </div>
        )}
        ...
        <ConnectionList
          initialData={data}
          initialPage={page}
          searchHref={ROUTES.PSYCHOLOGIST_SEARCH}
